...
public class GameController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GeneralShopController.i.OnStart += () => state = GameState.GeneralShop;
        GeneralShopController.i.OnFinish += () => state = GameState.FreeRoam;
    }
    ...
    private void Update()
    {
        ...
        else if (state == GameState.GeneralShop)
        {
            GeneralShopController.i.HandleUpdate();
        }
    }
